namespace AnalysisVBFormApl
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.exLabel1 = new OyuLib.Windows.Forms.ExLabel(this.components);
            this.exTxtDBCRUD = new OyuLib.Windows.Forms.ExTextBox(this.components);
            this.exBtnCopyMemo = new OyuLib.Windows.Forms.ExButton(this.components);
            this.exBtnReload = new OyuLib.Windows.Forms.ExButton(this.components);
            this.exBtnWrite = new OyuLib.Windows.Forms.ExButton(this.components);
            this.exTxtMemo = new OyuLib.Windows.Forms.ExTextBox(this.components);
            this.exTxtSearchText = new OyuLib.Windows.Forms.ExButton(this.components);
            this.exTxtSearch = new OyuLib.Windows.Forms.ExTextBox(this.components);
            ...
            this.exTextSource = new OyuLib.Windows.Forms.ExTextBox(this.components);
            this.lblFileName = new OyuLib.Windows.Forms.ExLabel(this.components);
            this.exVBFileDialogButton1 = new OyuLib.Windows.Forms.ExVBFileDialogButton(this.components);
            this.exTxtSourcepath = new OyuLib.Windows.Forms.ExTextBox(this.components);
            this.exDataGridView1 = new OyuLib.Windows.Forms.DataGridView.ExDataGridViewControl(this.components);
            this.exBtnCopyOrino = new OyuLib.Windows.Forms.ExButton(this.components);
            ...
            this.exButton6 = new OyuLib.Windows.Forms.ExButton(this.components);
        ...
        private OyuLib.Windows.Forms.ExTextBox exTxtSourcepath;
        private OyuLib.Windows.Forms.DataGridView.ExDataGridViewControl exDataGridView1;
        private System.Windows.Forms.Label label1;
        private OyuLib.Windows.Forms.ExVBFileDialogButton exVBFileDialogButton1;
        private OyuLib.Windows.Forms.ExLabel lblFileName;
        private OyuLib.Windows.Forms.ExTextBox exTextSource;
        ...
        private OyuLib.Windows.Forms.ExTextBox exTxtSearch;
        private OyuLib.Windows.Forms.ExButton exTxtSearchText;
        private System.Windows.Forms.CheckBox checkBox1;
        private OyuLib.Windows.Forms.ExTextBox exTxtMemo;
        private OyuLib.Windows.Forms.ExButton exBtnWrite;
        private OyuLib.Windows.Forms.ExButton exBtnReload;
        private OyuLib.Windows.Forms.ExButton exBtnCopyMemo;
        private System.Windows.Forms.CheckBox chkColorMemo;
        private OyuLib.Windows.Forms.ExTextBox exTxtDBCRUD;
        private OyuLib.Windows.Forms.ExLabel exLabel1;
        private OyuLib.Windows.Forms.ExButton exBtnCopyOrino;
        private OyuLib.Windows.Forms.ExButton exButton4;
        private OyuLib.Windows.Forms.ExButton exButton5;
        private OyuLib.Windows.Forms.ExButton exButton6;
