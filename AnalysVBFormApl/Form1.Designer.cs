namespace AnalysVBFormApl
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.exLabel1 = new CommonCompornent.ExButton.ExLabel(this.components);
            this.exTxtDBCRUD = new CommonCompornent.ExTextBox(this.components);
            this.exBtnCopyMemo = new CommonCompornent.ExButton.ExButton(this.components);
            this.exBtnReload = new CommonCompornent.ExButton.ExButton(this.components);
            this.exBtnWrite = new CommonCompornent.ExButton.ExButton(this.components);
            this.exTxtMemo = new CommonCompornent.ExTextBox(this.components);
            this.exTxtSearchText = new CommonCompornent.ExButton.ExButton(this.components);
            this.exTxtSearch = new CommonCompornent.ExTextBox(this.components);
            this.exButton3 = new CommonCompornent.ExButton.ExButton(this.components);
            this.exButton2 = new CommonCompornent.ExButton.ExButton(this.components);
            this.exButton1 = new CommonCompornent.ExButton.ExButton(this.components);
            this.exTextSource = new CommonCompornent.ExTextBox(this.components);
            this.lblFileName = new CommonCompornent.ExButton.ExLabel(this.components);
            this.exVBFileDialogButton1 = new CommonCompornent.ExButton.ExVBFileDialogButton(this.components);
            this.exTxtSourcepath = new CommonCompornent.ExTextBox(this.components);
            this.exDataGridView1 = new CommonCompornent.ExDataGridViewControl(this.components);
            this.exBtnCopyOrino = new CommonCompornent.ExButton.ExButton(this.components);
            this.exButton4 = new CommonCompornent.ExButton.ExButton(this.components);
            this.exButton5 = new CommonCompornent.ExButton.ExButton(this.components);
            this.exButton6 = new CommonCompornent.ExButton.ExButton(this.components);
        ...
        private CommonCompornent.ExTextBox exTxtSourcepath;
        private CommonCompornent.ExDataGridViewControl exDataGridView1;
        private System.Windows.Forms.Label label1;
        private CommonCompornent.ExButton.ExVBFileDialogButton exVBFileDialogButton1;
        private CommonCompornent.ExButton.ExLabel lblFileName;
        private CommonCompornent.ExTextBox exTextSource;
        private CommonCompornent.ExButton.ExButton exButton1;
        private CommonCompornent.ExButton.ExButton exButton2;
        private CommonCompornent.ExButton.ExButton exButton3;
        private CommonCompornent.ExTextBox exTxtSearch;
        private CommonCompornent.ExButton.ExButton exTxtSearchText;
        private System.Windows.Forms.CheckBox checkBox1;
        private CommonCompornent.ExTextBox exTxtMemo;
        private CommonCompornent.ExButton.ExButton exBtnWrite;
        private CommonCompornent.ExButton.ExButton exBtnReload;
        private CommonCompornent.ExButton.ExButton exBtnCopyMemo;
        private System.Windows.Forms.CheckBox chkColorMemo;
        private CommonCompornent.ExTextBox exTxtDBCRUD;
        private CommonCompornent.ExButton.ExLabel exLabel1;
        private CommonCompornent.ExButton.ExButton exBtnCopyOrino;
        private CommonCompornent.ExButton.ExButton exButton4;
        private CommonCompornent.ExButton.ExButton exButton5;
        private CommonCompornent.ExButton.ExButton exButton6;
