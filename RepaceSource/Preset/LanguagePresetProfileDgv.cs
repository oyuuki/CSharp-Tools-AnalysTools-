...
{
    public abstract class LanguagePresetProfileDgv
    {
        #region Const
        ...
        protected LanguagePresetProfile _prof = null;
        ...
        /// Constructor
        /// </summary>
        protected LanguagePresetProfileDgv(
            LanguagePresetProfile prof,
        ...
        protected LanguagePresetProfileDgv(
            ...
            string keyColName,
            params string[] colNameArray)
            : this(new LanguagePresetProfile(constValue), uniqueFileNamepart, exDgv, keyColName, colNameArray)
        {
        ...
        public LanguagePresetProfile Prof
        {
