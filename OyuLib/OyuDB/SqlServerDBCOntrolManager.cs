...
namespace OyuLib.DB
{
    ...
    public class SqlServerDBCOntrolManager : DBControlManagerUtil
    {
        ...
        public SqlServerDBCOntrolManager(string loginUserName, string password, string serverName, string dbName)
        {
