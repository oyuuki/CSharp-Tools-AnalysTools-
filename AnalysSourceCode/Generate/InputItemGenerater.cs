...
{
    abstract class InputItemGenerater : GeneralObject
    {
        #region constractor

        public InputItemGenerater(string sourceText, int hierarchyIndex, string itemSignature)
                : base(sourceText, hierarchyIndex, itemSignature)
        {
            
        }

        public InputItemGenerater()
        {
        }
        ...
        public InputItem GetInputItem()
        {
            ...
            return new InputItem(id, name, format, type, beam, source, tabIndex, readonlyFlg, imeMode, hierarchyIndex, itemSignature);
        }
